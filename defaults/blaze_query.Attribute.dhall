{ DEPRECATED_glob_criteria =
    [] : List ./../types/blaze_query.DEPRECATED_GlobCriteria.dhall
, DEPRECATED_parseable_location =
    ./blaze_query.Location.dhall
, DEPRECATED_string_dict_unary_value =
    [] : List Text
, fileset_list_value =
    [] : List ./../types/blaze_query.FilesetEntry.dhall
, int_list_value =
    [] : List Natural
, label_dict_unary_value =
    [] : List ./../types/blaze_query.LabelDictUnaryEntry.dhall
, label_keyed_string_dict_value =
    [] : List ./../types/blaze_query.LabelKeyedStringDictEntry.dhall
, label_list_dict_value =
    [] : List ./../types/blaze_query.LabelListDictEntry.dhall
, string_dict_value =
    [] : List ./../types/blaze_query.StringDictEntry.dhall
, string_list_dict_value =
    [] : List ./../types/blaze_query.StringListDictEntry.dhall
, string_list_value =
    [] : List Text
, boolean_value =
    None Bool
...
, int_value =
    None Natural
, license =
    None ./../types/blaze_query.License.dhall
, nodep =
    None Bool
, selector_list =
    None
